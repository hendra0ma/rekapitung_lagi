...
<div class="row mt-3">
    <div class="col-lg-12">
      ...
      <center>
        <h4 class="fs-4 mt-2 fw-bold">Super Administrator (Pentagon)</h4> <!-- This Dummy Data -->
      </center>
      <hr style="border: 2px solid; margin-top: 3rem; margin-bottom: 3rem">
    </div>
    {{-- <div class="col-lg-8">
        <div class="row">
            <div class="col-6">
...
<div class="tab mt-5">
    <div class="row">
        <div class="col-md">
            ...
            ?>
            <button class="btn tablink w-100 rounded-0 c1saksi" onclick="openPage('C1-Saksi', this, '#45aaf2 ')" id="defaultOpen">Verifikator <span class="badge rounded-pill bg-danger">{{$count_suara}}</span></button>
        </div>
        <!-- <div class="col-md">
            <button class="btn tablink w-100 rounded-0 c1partai" onclick="openPage('C1-Partai', this, '#f7b731')">C1 Partai</button>
        </div> -->
        <div class="col-md">
            <button class="btn tablink w-100 rounded-0 c1relawan" onclick="openPage('C1-Relawan', this, '#f82649')">Auditor</button>
        </div>
        <div class="col-md">
            <button class="btn tablink w-100 rounded-0 c1saksipend" onclick="openPage('C1-Saksi-Pending', this, '#6259ca ')" style="background-color: rgb(98, 89, 202);">
              Validator</button>
        </div>
        {{-- <div class="col-md">
...
<div id="C1-Saksi" class="tabcontent">
    <livewire:c1-developer-verifikator/>
</div>


<div id="C1-Relawan" class="tabcontent">
    <livewire:c1-developer-auditor/>
</div>
