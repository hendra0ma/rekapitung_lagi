<!-- {{ $kecamatan['name'] }} {{ Session::get('session_kecamatan')}}
<br>
...
<form action="/action_get_security/{{encrypt($kecamatan['id'])}}" method="post">
    @csrf
    <input type="text" name="password">
    <input type="hidden" name="id" value="{{ encrypt($kecamatan['id']) }}">
		...
		<div class="">
			...
			<div class="container-login100">
				<div class="wrap-login100 p-0">
					<div class="card-body">
						<form class="login100-form validate-form" action="/action_get_security/{{encrypt($kecamatan['id'])}}/{{$role}}" method="post">
							@csrf
