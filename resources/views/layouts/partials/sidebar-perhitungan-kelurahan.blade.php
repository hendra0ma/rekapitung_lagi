            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Hasil Perhitungan</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li><a href="#" onclick="window.location.href = '{{url('/')}}/administrator/index'" class="slide-item">Perhitungan Tingkat Kota</a></li>
                        <li class="sub-slide">
                            <a class="sub-side-menu__item" data-bs-toggle="sub-slide" href="#"><span class="sub-side-menu__label">Perhitungan Tingkat Kelurahan</span><i class="sub-angle fa fa-angle-right"></i></a>
                            <ul class="sub-slide-menu">
                                @foreach ($kelurahan as $rg)
                                <li><a class="sub-slide-item" href="{{url('/')}}/administrator/perhitungan_kelurahan/{{encrypt($rg['id'])}}">{{$rg['name']}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                    </ul>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="/key_kecamatan/{{encrypt($rg['id'])}}/{{encrypt(1)}}?title=Komparasi" class="slide-item">KEC. {{$rg['name']}}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li>
